...
export interface NodeGraphResponse {
  nodes: Array<{
    ...
    /** 통합 그래프에서 프로젝트 super-node 라벨로 사용 (identifier 보다 우선) */
...
export const issuesApi = {
  ...
  documentLinks: (workspaceSlug: string, projectId: string, issueId: string) =>
    api.get<{ id: string; document_id: string; document_title: string; document_icon_prop: unknown; space_id: string; space_name: string; created_at: string }[]>(
